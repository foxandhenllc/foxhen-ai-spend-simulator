# Contributing to AI Spend Simulator

AI Spend Simulator is part of the Fox & Hen public tool set. Contributions should keep the project useful, inspectable, forkable, and safe to demonstrate in public.

## Good First Contributions

- Add or improve a synthetic sample scenario that demonstrates: A simulator for AI usage, budget guardrails, provider costs, workload assumptions, and savings scenarios.
